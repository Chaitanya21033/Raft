...
class RaftNode:
    ...
    def recovery(self):
        ...
        self.node_logs_folder = self.logs_folder + '/node_' + self.server_id
        if not os.path.exists(self.node_logs_folder):
            os.makedirs(self.node_logs_folder)

        self.log_file_path = self.node_logs_folder + '/log.txt'
        self.metadata_file_path = self.node_logs_folder + '/metadata.txt'
        self.dump_file_path = self.node_logs_folder + '/dump.txt'
...
'''
## Function to run multiple servers on the same terminal
def serve():
...
def serve():
    ...
    None
    """
    servers = {'50051':'10.190.0.2:50051',
               '50052': '10.190.0.2:50052',
               '50053': '10.190.0.3:50053',
               '50054': '10.190.0.3:50054',
               '50055': '10.190.0.4:50055',
            }
